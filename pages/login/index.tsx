		...
		<div className="pages-body login-page flex flex-column">
			...
			<div className="align-self-center mt-auto mb-auto">
				<div className="pages-panel card flex flex-column">
					...
					<div className="input-panel flex flex-column px-3">
						<div className="p-inputgroup">
							...
							<span className="p-float-label">
								<InputText onChange={e => setUsername(e.target.value)} type="text" id="inputgroup1" data-testid="login-input" />
					...
					<DynamicButton onClick={goRegister} className="p-button-secondary" label="Register" data-testid="register-button"></DynamicButton>
					</div>
				</div>
			</div>
		</div>
